...
| Axiom | Skill/Pipeline | Contract-enforced 8-stage pipeline: EARS requirements, ATDD, RALPLAN-DR deliberation, 3 parallel reviewers, classified self-correction, cross-run memory | [Guipetris/axiom](https://github.com/Guipetris/axiom) |
